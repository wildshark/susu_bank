        ...
        switch($_REQUEST['_submit'])
        {
            ...
            case'add-contribution':
                ...
                case'add-staff':
                    ...
                    $data['lastName'] =$_POST['last_name'];
                    $data['gender'] = $_POST['gender'] ?? 'male';
                    $data['dob'] = $_POST['dob'];
                    $data['maritalStatus'] = $_POST['marital_status'] ?? 'single';
                    $data['nationality'] = $_POST['nationality'] ?? 'N/A';
                    $data['mobile'] = $_POST['mobile'] ?? 'N/A';
                    $data['email'] = $_POST['email'] ?? 'N/A';
                    $data['postalAddress'] = $_POST['postal_address'] ?? 'N/A';
                    $data['digitalAddress'] = $_POST['digital_address'] ?? 'N/A';
                ...
                case'update-staff':
                    ...
                    $update = $staff->updateStaff($staffId, $data);
                    if($update == false){
                        $url['_main'] = $_COOKIE['_main'];
                        $url['id'] = $staffId;
                        $url['err'] = 110;
