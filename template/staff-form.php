...
<head>
    ...
    <title>Susu Admin - Update Staff</title>
    ...
    <div class="main-container">
        ...
        <div class="content">
            ...
            <div class="pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Update Staff Profile: <?=$firstName?> <?=$middleName?> <?=$lastName?></h1>
                <p class="text-muted">Staff ID: AC-<?=$agentId?></p>
            </div>
            <!-- Actions Header -->
            <div class="d-flex justify-content-between align-items-center mb-4">
                <a href="?_main=staffs" class="btn btn-outline-secondary">
            ...
            <!-- Update Form -->
            <div class="card">
                <h5 class="card-header"><i class="fas fa-user-edit me-2"></i>Edit Staff Details</h5>
                <div class="card-body">
                    ...
                    <form action="index.php" method="post" enctype="multipart/form-data">
                        ...
                        <h6 class="form-section-title">Login Details</h6>
                        <div class="row">
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="submit" name="_submit" value="update-staff" class="btn btn-primary"><i
