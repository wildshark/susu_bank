...
<head>
    ...
    <title>Susu Admin - Member Management</title>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0"><i class="fas fa-users me-2"></i>All Members</h5>
                                            ...
                                            if($members && count($members) > 0){
                                                foreach($members as $r){
                                                    ...
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href='?_main=contribution-detail&id=$clientID' class=\"btn btn-sm btn-info\"><i class=\"fas fa-eye\"></i></a>
                                                            <a href='?_main=member-detail&id=$clientID' class=\"btn btn-sm btn-warning\"><i class=\"fas fa-edit\"></i></a>
                                                            <a href='?_submit=del-member&id=$clientID' class=\"btn btn-sm btn-danger\"><i class=\"fas fa-trash\"></i></button>
                                                        </td>
                                                    </tr>";
                                                }
                                            }
                    ...
                    <form action="index.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3"><label for="nokName" class="form-label">Full Name</label><input
                                    type="text" class="form-control" id="nokName" name="nok_name" required></div>
                            <div class="col-md-4 mb-3"><label for="nokRelationship"
                                    class="form-label">Relationship</label><input type="text" class="form-control"
                                    id="nokRelationship" name="nok_relationship" required></div>
                            <div class="col-md-4 mb-3"><label for="nokMobile" class="form-label">Mobile
                                    ...
                                    name="nok_mobile" required></div>
                        </div>

                        <h6 class="form-section-title">Document Upload</h6>
                        <div class="row">
                            <div class="col-md-6 mb-3"><label for="passportUpload" class="form-label">Upload Passport
                                    Photo</label><input class="form-control" type="file" id="passportUpload"
                                    name="passport_upload"></div>
                            <div class="col-md-6 mb-3"><label for="idUpload" class="form-label">Upload Government Issued
                                    ID</label><input class="form-control" type="file" id="idUpload" name="id_upload">
                            </div>
                        </div>

                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="submit" name="_submit" value="add-member" class="btn btn-primary">Save
                                Member</button>
                        </div>
                    </form>
                </div>
